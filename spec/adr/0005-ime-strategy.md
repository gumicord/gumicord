...
| | |
|---|---|
| ステータス | **承認 → 保留** — 前提が崩れた。末尾の[2026-08-22 の追記](#2026-08-22-追記-候補ウィンドウが出たこの決定は見直しが要る-)を先に読むこと |
| 起票日 | 2026-08-14 |
| 決定日 | 2026-08-14 |
| 保留日 | 2026-08-22 |
...
## 2026-08-22 追記: 候補ウィンドウが出た。**この決定は見直しが要る** ⚠️

> **ステータス: 決定は保留。** 下の観察が正しければ、この ADR の前提そのものが崩れる。
...
| # | 確かめること | なぜ |
|---|---|---|
| 1 | **Microsoft IME** で同じか | この ADR が名指しした 3 つのうちの 1 つ。未確認 |
| 2 | **ATOK** で同じか | 同上 |
