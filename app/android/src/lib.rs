...
fn android_main(app: winit::platform::android::activity::AndroidApp) {
    ...
    // Downloads exports happen on panic and from the settings screen only:
    // a quiet end leaves nothing behind by design, so normal runs do not
    // litter the shared storage.
